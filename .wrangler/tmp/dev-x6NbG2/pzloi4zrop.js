...
// .wrangler/tmp/pages-asroW3/bundledWorker-0.34437424962293295.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, s, a) => {
  if (t && typeof t == "object" || typeof t == "function") for (let i of ie(t)) !oe.call(e, i) && i !== s && X(e, i, { get: /* @__PURE__ */ __name2(() => t[i], "get"), enumerable: !(a = re(t, i)) || a.enumerable });
  return e;
}, "ce");
var U = /* @__PURE__ */ __name2((e, t, s) => (s = e != null ? se(ne(e)) : {}, ce(t || !e || !e.__esModule ? X(s, "default", { value: e, enumerable: true }) : s, e)), "U");
var g;
var l = I(() => {
  g = { collectedLocales: [] };
});
...
async function W(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let n = globalThis[ye], r = /* @__PURE__ */ __name2(async () => {
          let o = await e.json();
...
function Ie() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, s) => e.has(s) ? e.get(s) : Reflect.get(globalThis, s), "get"), set: /* @__PURE__ */ __name2((t, s, a) => Ne.has(s) ? Reflect.set(globalThis, s, a) : (e.set(s, a), true), "set") });
}
__name(Ie, "Ie");
__name2(Ie, "Ie");
...
// .wrangler/tmp/pages-asroW3/pzloi4zrop.js
...
// .wrangler/tmp/bundle-qX5O15/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-qX5O15/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=pzloi4zrop.js.map
